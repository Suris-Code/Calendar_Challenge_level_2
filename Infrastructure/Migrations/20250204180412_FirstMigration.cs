        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LoginMethod2FA = table.Column<int>(type: "int", nullable: false),
                    PrivateCode2FA = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastLogin2FA = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EnableTwoFA = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullUserName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    SourceColumnNumber = table.Column<int>(type: "int", nullable: true),
                    HttpErrorCode = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionDescriptorId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ActivityReference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserAgentFamily = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserAgentMajor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserAgentMinor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserAgentPatch = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OSFamily = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OSMajor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OSMinor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OSPatch = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DeviceIsSpider = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResentEmail = table.Column<bool>(type: "bit", nullable: false),
